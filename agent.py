...
gemini_model = ChatGoogleGenerativeAI(model="gemini-2.5-flash", temperature=0.7, max_tokens=1024)
...
def create_agent_graph():
    ...
    agent = create_agent(
        model=gemini_model, tools=[get_weather], system_prompt=system_prompt
    )
