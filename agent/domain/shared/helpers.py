"""Shared helpers for tracing and source document construction.

Extracted from RAGChain and ToolCallingAgent to eliminate duplication.
Note: `_extract_decision_metadata` is NOT here — RAG vs tool-calling logic differs.
"""
